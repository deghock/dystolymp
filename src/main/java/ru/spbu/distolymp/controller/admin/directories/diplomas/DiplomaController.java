...
public class DiplomaController {
    ...
    public String addDiploma(@Valid @ModelAttribute("diploma") NewDiplomaTypeDto newDiplomaType,
        ...
        diplomaTypeService.addNewDiplomaType(newDiplomaType);
        return REDIRECT_LIST;
    }

    @GetMapping("/edit/{id}")
    public String showEditDiplomaTypePage(@PathVariable("id") Integer id, ModelMap modelMap) {
        diplomaTypeService.fillEditDiplomaModelMap(id, modelMap);
        return EDIT_PAGE;
    }

    @PostMapping("/update")
    public String updateDiplomaType(@Valid @ModelAttribute("diploma") EditDiplomaTypeDto editDiplomaTypeDto,
                                    BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return EDIT_PAGE;
        }

        diplomaTypeService.updateDiplomaType(editDiplomaTypeDto);
        return REDIRECT_LIST;
    }
